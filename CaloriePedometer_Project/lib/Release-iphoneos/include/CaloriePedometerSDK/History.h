...
@class PacketsRecord, SleepDataRecord, SyncRecord;
...
@property (nonatomic, retain) NSSet *syncRecord;
@end
...
- (void)addSyncRecordObject:(SyncRecord *)value;
- (void)removeSyncRecordObject:(SyncRecord *)value;
- (void)addSyncRecord:(NSSet *)values;
- (void)removeSyncRecord:(NSSet *)values;
